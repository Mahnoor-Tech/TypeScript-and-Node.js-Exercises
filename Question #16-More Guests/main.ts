...
let guests: string[] = ["Tuba", "Rani", "Tabassum"];
let remove_name: string = "Tuba";
...
console.log(
  "We have just found a bigger dinner table, so now more guests can come and sit easily. \n"
);
...
guests.map((items) =>
  console.log(`Hey! ${items}, please come and and join us for dinner today. \n`)
);
